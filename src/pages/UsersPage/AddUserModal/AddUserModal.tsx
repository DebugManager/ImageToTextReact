...
export default function AddUserModal({
  ...
  const handleSelectAllChange = () => {
    ...
    const newCheckedItems: { [key: number]: boolean } = items.reduce(
      (acc, item) => {
    ...
    Object.keys(checked)
      ...
      .map((key) => {
        const permissionValue =
          permissionNameToValue[key as keyof typeof permissionNameToValue];
        ...
        if (checked[key as keyof typeof checked] === true) {
          if (checked.comment === true) {
            ...
            if (
              ...
              !user.user_permissions.includes(permissionValue)
            ) {
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              >
                <p className={styles.descriptionText}>
                  {t('1_Admin_Users_Have_Full_Rights_Over_The_Platform')}
                </p>
                <p className={styles.descriptionText}>
                  {t('2_Staff_Users_Have_Full_Rights_Over_The_Platform')}
                </p>
                <p className={styles.descriptionText}>
                  {t('3_Clients_Have_No_Rights_Over_The_Platform_By')}
                </p>
              </div>
                        ...
                        <FormControlLabel
                          ...
                          control={
                            <Checkbox
                              defaultChecked={
                                user
                                  ? user?.user_permissions?.includes(53)
                                  : checked.view || false
                              }
                        ...
                        <FormControlLabel
                          ...
                          control={
                            <Checkbox
                              defaultChecked={
                                user
                                  ? user?.user_permissions?.includes(54)
                                  : checked.view || false
                              }
                        ...
                        <FormControlLabel
                          ...
                          control={
                            <Checkbox
                              defaultChecked={
                                user
                                  ? user?.user_permissions?.includes(55)
                                  : checked.view || false
                              }
                        ...
                        <FormControlLabel
                          ...
                          control={
                            <Checkbox
                              defaultChecked={
                                user
                                  ? user?.user_permissions?.includes(56)
                                  : checked.view || false
                              }
                ...
                <div className={styles.pagestPermissionWrapper}>
                  <Box
                    sx={{
                      display: 'flex',
                      alignItems: 'center',
                      borderBottom: '1px solid var(--text-color-50, #EFF2F7)',
                      width: '100%',
                      padding: '4px 7px;',
                      marginRight: '8px',
                    }}
                  >
                    ...
                    />
                    <span className={styles.countChecked}>
                  ...
                  <div className={styles.itemsWrapper}>
                    {items.map((item) => (
                      <div
                        key={item.id}
                        className={styles.permissionToChoseWrapper}
                      >
                        <Checkbox
                          className={styles.customCheckBox}
                          sx={{
